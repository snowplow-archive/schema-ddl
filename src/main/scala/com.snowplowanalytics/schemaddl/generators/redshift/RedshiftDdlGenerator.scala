...
object RedshiftDdlGenerator {
   ...
   * @return SQL comment
   */
  def getHeader(flatSelfElems: SelfDescInfo): String =
    RedshiftDdlHeader ++ "-- Source: " + SU.getSchemaName(flatSelfElems) ++ "\n\n"
   ...
   * @return SQL comment
   */
  def getHeader(fileName: String): String =
    RedshiftDdlHeader ++ "-- Source: " + fileName ++ "\n\n"

  // Columns with data taken from self-descrining schema

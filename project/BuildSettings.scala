...
object BuildSettings {
  ...
  lazy val basicSettings = Seq[Setting[_]](
    ...
    version               :=  "0.1.0-M1",
    description           :=  "For deriving JSON Paths and Redshift DDLs from Self Describing JSONs",
    scalaVersion          :=  "2.10.1",
  ...
  lazy val scalifySettings = Seq(sourceGenerators in Compile <+= (sourceManaged in Compile, version, name, organization, scalaVersion) map { (d, v, n, o, sv) =>
    ...
    IO.write(file, """package com.snowplowanalytics.igluutils.generated
  ...
  lazy val sbtAssemblySettings = assemblySettings ++ Seq(
    ...
    mainClass in assembly := Some("com.snowplowanalytics.igluutils.Main")
  )
